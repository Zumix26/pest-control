...
class Container_cd4255a73a extends _PHPStan_5adafcbb8\Nette\DI\Container
{
	protected $tags = [
	...
	public function createService0437(): PHPStan\File\FileExcluderRawFactory
	{
		return new class ($this) implements PHPStan\File\FileExcluderRawFactory {
			...
			public function __construct(Container_cd4255a73a $container)
			{
	...
	public function createServiceContainer(): Container_cd4255a73a
	{
		return $this;
	}
